...
const products = [
  ...
  { name: 'Organic Dal', image: 'https://vamshifarms.com/cdn/shop/files/ecommified_httpss.mj.run1YPvs8udvp4_toor_dal_yellow_pusles_in_a_81c0e10d-f0ed-4888-b86a-2168b1a0c6ad.png?v=1720156594&width=848', description: 'Protein-rich lentils' },
  { name: 'Organic Sweetning', image: 'https://vamshifarms.com/cdn/shop/files/turmeric_0cd6f78f-4c29-4571-85a1-3799962846a6.jpg?v=1709098922&width=900', description: 'Traditional delicacies' },
